...
<head>
  ...
  <title>Temple Pass System || Collected Donation Amount</title>
  <!-- base:css -->
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Collected Donation Amount</h4>
                 
                  <form class="forms-sample" method="post" action="collected-amount-details.php">
