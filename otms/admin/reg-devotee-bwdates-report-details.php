...
?>
                  <h4 class="card-title" align="center">Between Dates Report of Registered Devotees from <?php echo $fdate;?> To <?php echo $tdate;?></h4>
...
?>
    ...
    $second_last = $total_no_of_pages - 1; // total page minus 1
                         ...
                         $query=mysqli_query($con,"select * from tbluser where RegDate between '$fdate' and '$tdate' LIMIT $offset, $total_records_per_page");
$cnt=1;
