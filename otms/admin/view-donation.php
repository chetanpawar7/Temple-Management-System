        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-lg-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">View Donation Information</h4>
...
?>
                        <tr class="table-info">
                          ...
                          <td>
                           ...
                           <td>
                            <a href="view-donation-receipts.php?id=<?php echo $row['did']?>" class="btn-sm btn-warning">View</a>
