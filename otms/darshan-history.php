...
?>
                     ...
                     <?php } else { ?>
                      <td><?php  echo $row['Status'];?></td><?php } ?> 
                           ...
                           <td>
                            <a href="view-booking-details.php?id=<?php echo $row['bid']?>" class="btn btn-primary">View Detail</a>
